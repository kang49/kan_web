    ...
    <div class="w-full min-h-[calc(100dvh)]">
        <div class="w-full h-max pt-[100px] px-[20px]">
            <div class="w-full h-max flex items-center">
                <i class="far fa-tags mr-[5px] text-green-500"></i>
                <NuxtLink v-if="page_lang === 'EN'" to="/tags" class="text-[20px] font-bold text-green-500">Tags</NuxtLink>
                <NuxtLink v-if="page_lang === 'TH'" to="/tags" class="text-[20px] font-bold text-green-500">แท็ก</NuxtLink>
                <i class="fal fa-long-arrow-right text-[30px] px-[10px]"></i>
                <h1 class="text-black text-[20px] font-bold truncate"># {{ tags_name }}</h1>
            </div>
